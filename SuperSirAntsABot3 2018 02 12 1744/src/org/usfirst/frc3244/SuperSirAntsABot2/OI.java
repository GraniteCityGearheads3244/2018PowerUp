...
public class OI {
  ...
  //Xbox game pad Channels
    ...
    private void setUp_SmartDashboard_Buttons(){
    	...
    	SmartDashboard.putData("Scissor to CLIMB", new ScissorToSetpoint(Robot.scissor.CLIMB));
    	SmartDashboard.putData("Scissor to SCALE", new ScissorToSetpoint(Robot.scissor.SCALE));
    	...
    	SmartDashboard.putData("Wrist Up", new CommandGroup_Wrist_Up());//Wrist_Up(1));
