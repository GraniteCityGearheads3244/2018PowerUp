...
public class DriveTrain extends Subsystem {
    ...
    public void my_DriveMechanum(double ySpeed, double xSpeed, double zRotation, double gyroAngle) {
    	mecanumDrive1.driveCartesian(ySpeed, xSpeed, zRotation, gyroAngle);
    }
