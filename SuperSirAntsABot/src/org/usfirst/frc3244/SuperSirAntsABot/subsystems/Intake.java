...
public class Intake extends Subsystem {
    ...
    private final DoubleSolenoid rollers = RobotMap.intakeRollers;
    private final DoubleSolenoid wrist = RobotMap.intakeWrist;
    ...
    public void my_wrist_lower(boolean lower) {
    	if (lower) {
