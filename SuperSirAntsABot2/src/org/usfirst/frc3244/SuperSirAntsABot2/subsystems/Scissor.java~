 ...
 // member variables to support closed loop mode
    ...
    public Scissor() {
    	...
    	for (talonIndex = 0; talonIndex < kMaxNumberOfMotors; talonIndex++) {
    		...
    		m_talons[talonIndex].setInverted(true);
    	}
		...
		for (talonIndex = 0; talonIndex < kMaxNumberOfMotors; talonIndex++) {
			m_talons[talonIndex].configMotionCruiseVelocity(2445, Constants.kTimeoutMs);
			m_talons[talonIndex].configMotionAcceleration(2445, Constants.kTimeoutMs);
		}
		/* zero the sensor */
		for (talonIndex = 0; talonIndex < kMaxNumberOfMotors; talonIndex++) {
