...
public class OI {
  ...
  //Xbox game pad Channels
    ...
    public OI() {
        ...
        x.whileHeld(new Scissor_MotionMagic_Command(Robot.scissor.CLIMB));
        y = new JoystickButton(xbox_Driver, GAMEPAD_XBOX_Y_BUTTON);
        y.whileHeld(new Scissor_MotionMagic_Command(Robot.scissor.DOWN));
        b = new JoystickButton(xbox_Driver, GAMEPAD_XBOX_B_BUTTON);
        b.whileHeld(new Scissor_MotionMagic_Command(Robot.scissor.SCALE));
        a = new JoystickButton(xbox_Driver, GAMEPAD_XBOX_A_BUTTON);
        a.whileHeld(new Scissor_MotionMagic_Command(Robot.scissor.SWITCH));
